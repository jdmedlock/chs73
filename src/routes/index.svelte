		...
		<div class="container mx-auto px-4">
				...
				<div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
					...
					>
						<div class="px-4 py-5 flex-auto">
							...
							<h6 class="text-xl font-semibold">Renew old friendships</h6>
							<p class="mt-2 mb-4 text-gray-600">
								It's going to be a lot of fun and it's the perfect time and it's
								way to reconnect with old friends and acquaintances.
							</p>
						</div>
					</div>
				</div>
				<div class="w-full md:w-4/12 px-4 text-center">
					<div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
						<div class="px-4 py-5 flex-auto">
							...
							<h6 class="text-xl font-semibold">Our 50th Reunion!</h6>
							<p class="mt-2 mb-4 text-gray-600">
								Our 50th reunion in 2023 is closer than you think. It's a
								time to prepare!
							</p>                
						</div>
					</div>
				...
				<div class="pt-6 w-full md:w-4/12 px-4 text-center">
					...
					>
						<div class="px-4 py-5 flex-auto">
							...
							<h6 class="text-xl font-semibold">Be a Hero & Volunteer</h6>
							<p class="mt-2 mb-4 text-gray-600">
								Organizing this is a huge job and we need and we'd like need to
								everyone's help.
							</p>
						</div>
					</div>
			...
			<div class="flex flex-wrap items-center mt-32">
				...
				<div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
					<div
						class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-sepia-300"
					>
						<img
							alt="..."
