...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div2, file, 73, 10, 2641);
			attr_dev(div3, "class", "flex flex-col ml-2");
			add_location(div3, file, 72, 8, 2598);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(72:6) {#if confirmed === 'FALSE'}",
		ctx
	});
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 91, 6, 3400);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(91:4) {#if confirmed === 'FALSE'}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div1, file, 36, 2, 1128);
			attr_dev(div2, "class", "flex place-self-center");
			add_location(div2, file, 67, 8, 2478);
